  ...
  return (
    ...
    <div className='bg-[White]  w-[100%] rounded-lg '>
                  <nav className='flex p-2'>
                     <div className='ml-2 flex-2 h-[1.875rem] w-[1.875rem]'><img src={comment.user.image.png} className='w-full h-full object-cover'></img></div>
                      <div className='ml-3 text-Dark_Blue font-semibold'>{comment.user.username}</div>
                      <div className='ml-2 mt-[0.125rem] h-[1.3rem] rounded px-2 bg-Moderate_Blue text-[White] text-[0.75rem] font-semibold'>you</div>
            <div className='ml-4 text-Grayish_Blue'>{comment.createdAt}</div>
          </nav>
         <p className='text-left text-[1rem] px-4 text-Grayish_Blue break-words'>{comment.content}</p>
          <div className='flex justify-between mt-1 '>
            <div className="flex items-center justify-between h-[1.875rem] bg-Very_Light_Gray hover:bg-gray-100 text-gray-800 font-semibold px-2 rounded-lg shadow ml-4 mt-2 mb-[0.75rem]">
                <button
               
                className="focus:outline-none text-[1.25rem] font-thick block text-Light_Grayish_Blue">
                 +
                </button>
                            <span className="text-[1rem]  ml-2 text-Moderate_Blue">{comment.score}</span>
              <button
               
                className="focus:outline-none text-[1.75rem]  font-thick ml-3 block text-Light_Grayish_Blue">
                -
                </button>
                      </div>
            ...
            <div className='flex'>
              <span
                onClick={()=>handleCommentDeleteConfirmation(commentIndex)}
                className='flex items-center justify-between h-[30px]   border-White  font-semibold px-2  rounded-lg ml-16  mt-2 mb-[18px]  '>
              <svg className='relative top-[1px] left-[-6px]' width="12" height="14" xmlns="http://www.w3.org/2000/svg"><path d="M1.167 12.448c0 .854.7 1.552 1.555 1.552h6.222c.856 0 1.556-.698 1.556-1.552V3.5H1.167v8.948Zm10.5-11.281H8.75L7.773 0h-3.88l-.976 1.167H0v1.166h11.667V1.167Z" fill="#ED6368"/></svg>
             <p className='relative top-[1px]   text-Soft_Red'>Delete</p>
              </span>
              
              <span
                onClick={() => handleCommentEdit(commentIndex)}
                className='flex items-center justify-between h-[30px]   border-White  font-semibold px-2 rounded-lg  mr-2 mt-2 mb-[18px] '>
              <svg className='relative top-[1px] left-[-6px]' width="14" height="14" xmlns="http://www.w3.org/2000/svg"><path d="M13.479 2.872 11.08.474a1.75 1.75 0 0 0-2.327-.06L.879 8.287a1.75 1.75 0 0 0-.5 1.06l-.375 3.648a.875.875 0 0 0 .875.954h.078l3.65-.333c.399-.04.773-.216 1.058-.499l7.875-7.875a1.68 1.68 0 0 0-.061-2.371Zm-2.975 2.923L8.159 3.449 9.865 1.7l2.389 2.39-1.75 1.706Z" fill="#5357B6"/></svg>
             <p className='relative top-[1px]  text-Moderate_Blue'>Edit</p>
            </span>
            </div>       
    ...
    <div className='bg-[White]  w-[100%] rounded-lg'>
          ...
          <p className='text-left text-[1rem] px-4 text-Grayish_Blue'>{comment.content}</p>
          ...
          <div className='flex justify-between mt-1 '>
            ...
            <span
              ...
              className='flex items-center justify-between h-[30px]   border-White  font-semibold px-2 rounded-lg  mr-2 mt-2 mb-[18px] '>
             <svg className='relative top-[1px] left-[-6px]' width="14" height="13" xmlns="http://www.w3.org/2000/svg"><path d="M.227 4.316 5.04.16a.657.657 0 0 1 1.085.497v2.189c4.392.05 7.875.93 7.875 5.093 0 1.68-1.082 3.344-2.279 4.214-.373.272-.905-.07-.767-.51 1.24-3.964-.588-5.017-4.829-5.078v2.404c0 .566-.664.86-1.085.496L.227 5.31a.657.657 0 0 1 0-.993Z" fill="#5357B6" /></svg>
             <p className='relative top-[1px]  text-Moderate_Blue'>Reply</p>
            </span>
           </div>
        </div>
      </div>  
          ...
          {commentReplyToUser !== null && commentReplyToUser === commentIndex ? (
            <div className='flex justify-center align-center mt-6 ml-6'>
                  <div className='flex bg-[White] w-full rounded-lg'>
                    <div className='flex-grow-4'>
                    </div>
                    <div className='flex-1'>
          ...
          {/*PASTE HERE */}
<div className="border-l-2 ml-8 border-Light_Gray">
    ...
    <div className='bg-[White]  w-[100%] rounded-lg '>
                  <nav className='flex p-2'>
                     <div className='ml-2 flex-2 h-[1.875rem] w-[1.875rem]'><img src={reply.user.image.png} className='w-full h-full object-cover'></img></div>
                      <div className='ml-3 text-Dark_Blue font-semibold'>{reply.user.username}</div>
                      <div className='ml-2 mt-[0.125rem] h-[1.3rem] rounded px-2 bg-Moderate_Blue text-[White] text-[0.75rem] font-semibold'>you</div>
            <div className='ml-4 text-Grayish_Blue'>{reply.createdAt}</div>
          </nav>
          <p className="text-left text-[1rem] px-4 text-Grayish_Blue break-words ">
          ...
          <div className='flex justify-between mt-1 '>
            <div className="flex items-center justify-between h-[1.875rem] bg-Very_Light_Gray hover:bg-gray-100 text-gray-800 font-semibold px-2 rounded-lg shadow ml-4 mt-2 mb-[0.75rem]">
                ...
                className="focus:outline-none text-[1.25rem] font-thick block text-Light_Grayish_Blue">
                        +
                              ...
                              <span className="text-[1rem]  ml-2 text-Moderate_Blue">{reply.score}</span>
              <button
            ...
            <div className='flex'>
              <span
                onClick={()=>handleReplyDeleteConfirmation(commentIndex,replyIndex)}
                className='flex items-center justify-between h-[30px]   border-White  font-semibold px-2  rounded-lg ml-16  mt-2 mb-[18px]  '>
              <svg className='relative top-[1px] left-[-6px]' width="12" height="14" xmlns="http://www.w3.org/2000/svg"><path d="M1.167 12.448c0 .854.7 1.552 1.555 1.552h6.222c.856 0 1.556-.698 1.556-1.552V3.5H1.167v8.948Zm10.5-11.281H8.75L7.773 0h-3.88l-.976 1.167H0v1.166h11.667V1.167Z" fill="#ED6368"/></svg>
             <p className='relative top-[1px]   text-Soft_Red'>Delete</p>
              </span>
              ...
              <span
                onClick={() => handleReplyEdit(replyIndex,commentIndex)}
                className='flex items-center justify-between h-[30px]   border-White  font-semibold px-2 rounded-lg  mr-2 mt-2 mb-[18px] '>
              <svg className='relative top-[1px] left-[-6px]' width="14" height="14" xmlns="http://www.w3.org/2000/svg"><path d="M13.479 2.872 11.08.474a1.75 1.75 0 0 0-2.327-.06L.879 8.287a1.75 1.75 0 0 0-.5 1.06l-.375 3.648a.875.875 0 0 0 .875.954h.078l3.65-.333c.399-.04.773-.216 1.058-.499l7.875-7.875a1.68 1.68 0 0 0-.061-2.371Zm-2.975 2.923L8.159 3.449 9.865 1.7l2.389 2.39-1.75 1.706Z" fill="#5357B6"/></svg>
             <p className='relative top-[1px]  text-Moderate_Blue'>Edit</p>
            </span>
    ...
    <div className='bg-[White]  w-[100%] rounded-lg'>
           ...
           <p className="text-left text-[1rem] px-4 text-Grayish_Blue ">
                             <span className='font-semibold text-Moderate_Blue'>@{reply.replyingTo}</span>  {reply.content}
             </p>
   ...
   <>
            <div>
    <div className="relative m-4 rounded-lg border rounded-lg border-gray-300">
      <textarea
        value={newCommentText}
        onChange={handleCommentChange}
        className="w-full h-40 px-4 py-2 text-gray-700 placeholder-gray-400 bg-transparent resize-none focus:outline-none focus:border-blue-500 rounded-lg sm:h-32 "
      ...
      <div className="absolute bottom-2 right-2 text-sm text-gray-500 ">
        {remainingChars} characters remaining
         ...
         <div className='flex justify-between'>
                  <img alt='User Avatar' className=' ml-4 h-7 w-7 ' src={data.currentUser.image.png}></img>
          <button
            onClick={handleCommentSubmit}
            className='py-2 px-6 mb-2 relative top-[-0.375rem] text-[White] bg-Moderate_Blue mr-4 rounded-lg '>Send</button>
              </div>
            </>
    </div>
  );
